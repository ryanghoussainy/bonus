        ...
        <LinearGradient colors={[Colours.background[theme], Colours.dealItem[theme]]} style={styles.container}>
            ...
            {loading ? (
                ...
                <ScrollView contentContainerStyle={styles.contentContainer}>
                    ...
                    <View style={styles.fieldContainer}>
                        <Text style={[styles.label, { color: Colours.text[theme] }]}>First Name *</Text>
                        <TextInput
                    ...
                    <View style={styles.fieldContainer}>
                        <Text style={[styles.label, { color: Colours.text[theme] }]}>Last Name *</Text>
                        <TextInput
                            style={[styles.inputField, {
                                backgroundColor: Colours.background[theme],
                                color: Colours.text[theme],
                    ...
                    <View style={styles.fieldContainer}>
                        <Text style={[styles.label, { color: Colours.text[theme] }]}>Mobile Number (Optional)</Text>
                        <TextInput
                            style={[styles.inputField, {
                                backgroundColor: Colours.background[theme],
                                color: Colours.text[theme],
